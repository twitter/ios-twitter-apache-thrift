...
class ThriftEncoderTests: XCTestCase {
    ...
    func testStructsTypes() throws {
        ...
        XCTAssertEqual(dataWithNilInSubObject.base64EncodedString(), "DAABAAYAAgAyAA==")
    }
...
extension ThriftEncoderTests {
    static var allTests : [(String, ((ThriftEncoderTests) -> () throws -> Void))] {
        return [
            ...
            ("testEnums", testEnums),
            ("testEncodingUnencodableType", testEncodingUnencodableType),
